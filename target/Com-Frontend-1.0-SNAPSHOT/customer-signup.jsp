<%-- 
    ...
    Created on : 06-Sep-2024, 20:00:37
    Author     : Dinindu
--%>
                ...
                <div class="col-md-8">
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                            <button type="submit" class="btn btn-primary" id="btnAddCustomer" onclick="addCustomer()">Signup</button>
                            <button type="button" class="btn btn-warning" id="btnClearCustomer" onclick="clearCustomer()">Clear</button>
                            <label>Have an account? <a href="customer-login.jsp">Login Now</a></label>
                        </div>
                    </form>
                </div>
            </div>
