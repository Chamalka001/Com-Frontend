<%-- 
    Document   : reservation-table
    Created on : 12-Sep-2024, 11:00:29
    Author     : Dinindu
--%>
    ...
    <body>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', () => {
                const apiEndpoint = 'http://localhost:8080/Backend/resources/reservation/'; // Replace with your API endpoint
...
//            populateTable(data);
        ...
        <div class="container reservation-container">
            ...
            <a href="staff-reservationDet.jsp" id="reserve-button" class="btn">Get Reservation Details By ID</a>
        </div>
